...
export const FEATURES = [
  ...
  {
    title: 'PvP Allowed',
    description: 'Full PvP is on. Fight for glory, raid unprotected stashes, and prove yourself in open combat.',
    icon: 'Sword',
  },
  {
    title: 'No Griefing',
  ...
  {
    title: 'Events & Raids',
    description: 'Server-wide PvP events, team wars, bounty hunts, and seasonal challenges to keep things spicy.',
    icon: 'Calendar',
  },
  {
    title: 'Whitelisted Only',
    description: 'Every player is hand-picked. We keep the server small and the community tight on purpose.',
    icon: 'Lock',
  },
];

export const SERVER_MODS = [
  {
    id: 'create',
    name: 'Create',
